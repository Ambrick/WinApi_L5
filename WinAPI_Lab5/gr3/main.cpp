...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	switch (message){
		...
		case WM_CREATE:
			...
			but =CreateWindowEx (WS_EX_CLIENTEDGE, L"BUTTON", L"Контроль вывода",  WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, 10, 10, 400, 30, hWnd, ( HMENU )BTN_PUSH, (HINSTANCE)GetWindowLong(hWnd, GWL_HINSTANCE), NULL);
			break;
			}
		case WM_PAINT:
